...
.highlight-line {
  @apply -mx-4 border-l-4 border-primary-500 bg-indigo-700 bg-opacity-50;
}

.line-number::before {
  @apply mr-4 -ml-2 inline-block w-4 text-right text-indigo-400;
  content: attr(line);
}
```
