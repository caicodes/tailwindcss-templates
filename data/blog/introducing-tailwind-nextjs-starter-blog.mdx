---
title: 'Introducing Tailwind C Starter Blog'
date: '2021-01-12'
lastmod: '2022-02-01'
tags: ['next-js', 'tailwind', 'guide']
draft: false
summary: 'Looking for a performant, out of the box template, with all the best in web technology to support your blogging needs? Checkout the Tailwind CSS Templates template.'
...
Facing issues? Check the [FAQ page](https://github.com/caicodes/tailwindcss-templates/wiki) and do a search on past issues. Feel free to open a new issue if none has been posted previously.

Feature request? Check the past discussions to see if it has been brought up previously. Otherwise, feel free to start a new discussion thread. All ideas are welcomed!

## Examples

- [Demo Blog](https://tailwindcss-templates.vercel.app/) - this repo
...
- [A markdown guide](https://tailwindcss-templates.vercel.app/blog/github-markdown-guide)
- [Learn more about images in Next.js](https://tailwindcss-templates.vercel.app/blog/guide-to-using-images-in-nextjs)
- [A tour of math typesetting](https://tailwindcss-templates.vercel.app/blog/deriving-ols-estimator)
- [Simple MDX image grid](https://tailwindcss-templates.vercel.app/blog/pictures-of-canada)
- [Example of long prose](https://tailwindcss-templates.vercel.app/blog/the-time-machine)
- [Example of Nested Route Post](https://tailwindcss-templates.vercel.app/blog/nested-route/introducing-multi-part-posts-with-nested-routing)
