  ...
  return (
    <SectionContainer>
      ...
      <article>
        <div>
          <header>
            <div className="space-y-1 border-b border-indigo-200 pb-10 text-center dark:border-indigo-700">
              <dl>
                <div>
          ...
          <div
            className="divide-y divide-indigo-200 pb-8 dark:divide-indigo-700 xl:divide-y-0 "
